...
|---|---|---|---|---|
| 1 | Довести бэктестер (позиции/PNL/force_close); синхронизировать единый конфиг | `futures_rebalance_backtester.py`, `unified_config*.json` | Тесты PASS; PnL ≠ 0 при движении; совпадение симуляции и реала ≥ 95 % | 2025‑09‑15 |
