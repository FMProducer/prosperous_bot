...
class TickerRanker:
    ...
    def calculate_metrics(self, threshold: float = 0.015) -> pd.DataFrame:
...
class TickerScanner:
    def __init__(self, concurrent_requests: int = 15, rebalance_threshold: float = 0.015, scanner_period_days: float = 0.125):
