...
class CustomD3QNStrategy(IStrategy):
    ...
    def hyperopt_parameters(self):
        try:
            from freqtrade.optimize.space import Real  # type: ignore
        except ImportError:
            return {}

        return {
            'd0': Real(0.03, 0.15, default=0.075),
            'd_min': Real(0.0001, 0.005, default=0.0008),
            'hysteresis': Real(0.0005, 0.005, default=0.0015),
        }
