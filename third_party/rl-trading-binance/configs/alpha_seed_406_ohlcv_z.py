# configs/alpha_seed_406_ohlcv_z.py — Все параметры RL-тренировки в одном месте
import torch
...
if AGENT_MODE == "UNIVERSAL":
    cfg.paths.config_name = "alpha_seed_406_ohlcv_z"
else:
    cfg.paths.config_name = f"alpha_seed_406_ohlcv_z_{AGENT_MODE}"
...
# Rolling Z-Score enabled in Environment/Strategy.
...
long_model_dir = BASE_DIR / "output" / "alpha_seed_406_ohlcv_z_LONG_ONLY" / "saved_models" / "rl_binance_futures_trading_date_20260110_time_133651"
short_model_dir = BASE_DIR / "output" / "alpha_seed_406_ohlcv_z_SHORT_ONLY" / "saved_models" / "rl_binance_futures_trading_date_20260110_time_191747"
single_model_dir = BASE_DIR / "output" / "alpha_seed_406_ohlcv_z_UNIVERSAL" / "saved_models" / "rl_binance_futures_trading_date_20251120_time_015257"
...
# python train.py --config alpha_seed_406_ohlcv_z.py --total_timesteps 10000  # Test
# python train.py --config alpha_seed_406_ohlcv_z.py  # Full
# python paper_trader_q.py --model rl_model.pth --config alpha_seed_406_ohlcv_z.py  # Backtest
