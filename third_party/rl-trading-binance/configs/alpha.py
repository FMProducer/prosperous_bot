...
cfg.model.dense_val = [256, 128, 64]  # Value head
...
cfg.trainlog.val_selection_metrics = ["Validation_sharpe", "Validation_sortino"]
cfg.trainlog.early_stopping_patience = 10

# Validation Gate (multi-crit; deny bad models)
cfg.validation_gate = {
    "min_sharpe": 0.3, "min_sortino": 0.5, "min_profit_factor": 1.1,
    "max_drawdown_at_most": -0.20, "min_win_rate": 0.50, "min_trades": 1000,
...
# Random/Logging
cfg.random_seed = 404
cfg.paths.config_name = "alpha_rl"
...
bundle_cfg.include_code_snapshot = True
