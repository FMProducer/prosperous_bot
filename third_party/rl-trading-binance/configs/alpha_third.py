...
cfg.trainlog.episodes = 300_000
cfg.trainlog.plot_top_n = 10
cfg.per.buffer_size = 160_000
...
# python train.py configs/alpha_third.py
# python test_agent.py configs/alpha_third.py
# python backtest_engine.py configs/alpha_third.py
# python optimize_cfg.py configs/alpha_third.py

# Mini run with 10 short sessions
# python optimize_cfg.py configs/alpha_third.py --trials 100 --jobs 1

# Notes: Default metric is values_0; default direction is max.
# python get_info_from_optuna.py configs/alpha_third.py --n-best-trials 10

# rm -r output/alpha_third

# Main workflow:
# Step                              Command
# 1. Train the model:               python train.py configs/alpha_third.py
# 2. Update the cache:              python backtest_engine.py configs/alpha_third.py  | When running a backtest, set backtest_mode = True
# 3. Run optimization:              python optimize_cfg.py configs/alpha_third.py
# 4. Show and save top-n trials:    python get_info_from_optuna.py configs/alpha_third.py

cfg.db.dsn = "postgresql://postgres:9691@localhost:5432/marketdata"
cfg.paths.norm_stats_path = "C:\\Python\\Prosperous_Bot\\output\\alpha_third\\norm_stats.json"
# 
...
cfg.paths.model_path = r"C:\\Python\\Prosperous_Bot\\output\\alpha_third\\saved_models\\<ИМЯ_ПАПКИ_С_ДАТОЙ>\\best.pth"
