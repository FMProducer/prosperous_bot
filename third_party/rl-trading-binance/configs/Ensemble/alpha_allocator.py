# configs/alpha_allocator.py
from configs.alpha import cfg as base_cfg
cfg = base_cfg

cfg.random_seed = 101

cfg.trainlog.episodes = 450_000
...
cfg.detector.context_minutes = 240
cfg.detector.window_minutes = 30
cfg.detector.cooldown_minutes = 60
cfg.detector.use_lookahead = False

cfg.signals.long_action_threshold = 0.0090
cfg.signals.short_action_threshold = 0.0090
