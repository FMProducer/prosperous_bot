...
cfg.rl.gamma = 0.997
cfg.rl.n_step = 5
# альтернативы: "Validation_mean_reward" и "Validation_win_rate"
cfg.trainlog.val_selection_metrics = "Validation_mean_pnl"
...
cfg.random_seed = 202 # или любое другое целое число
...
cfg.paths.norm_stats_path = "C:\\Python\\Prosperous_Bot\\output\\alpha_trend_mtf\\norm_stats.json"
# 
...
cfg.paths.model_path = r"C:\Python\Prosperous_Bot\third_party\rl-trading-binance\output\alpha\saved_models\rl_binance_futures_trading_date_20251029_time_003546\best.pth"
