...
cfg.market.holding_penalty_threshold = 45  # 15 * 3 (пропорционально)
# Порог отката прибыли для штрафа за жадность (0.50 = 50%)
cfg.market.greed_penalty_threshold = 0.60  # Больше терпения
...
cfg.market.fast_exit_threshold = 40  # 20 * 2
...
cfg.ensemble.conflict_cooldown_bars = 60 # 525600 (1 год)